...
export function GlobalStatusBar() {
  ...
  if (focusMode || isStudioRoute) return null;
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed bottom-0 left-0 right-0 z-[100] h-9 flex items-center justify-between px-4 text-xs tracking-wider transition-all duration-500 select-none",
          fontClass,
      ...
      >
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="opacity-70">UPTIME: {uptime}s</span>
          </div>
