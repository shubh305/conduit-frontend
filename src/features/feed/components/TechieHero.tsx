...
export function TechieHero({ item, currentTenantSlug }: TechieHeroProps) {
      ...
      <div className="flex flex-col md:flex-row min-h-[300px]">
        ...
        <div className="flex-1 p-6 lg:p-8 flex flex-col justify-center relative z-20">
          ...
          <div className="mt-2 pt-4 border-t border-white/5 flex flex-col gap-4">
            <p className="text-sm text-foreground/50 max-w-lg font-sans leading-relaxed line-clamp-2">{item.excerpt}</p>
        ...
        <div className="w-full md:w-[40%] lg:w-[35%] relative overflow-hidden bg-noir-panel/10">
          {item.featuredImage ? (
            ...
            <div className="absolute inset-0 flex items-center justify-center border-l border-white/5">
              <span className="text-accent font-mono text-2xl font-bold opacity-5 uppercase select-none -rotate-12 tracking-tighter">
                NULL_VID
              </span>
            </div>
          )}
