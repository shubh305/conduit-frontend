...
export function JournalFeedCard({ item, className, variant = "default", onRemove }: JournalFeedCardProps) {
  ...
  return (
    <div
      className={cn(
        "group relative flex flex-col bg-[var(--journal-paper)] hover:bg-white transition-all duration-500 h-full shadow-[6px_6px_0_rgba(0,0,0,0.05),12px_12px_0_rgba(0,0,0,0.02)] hover:shadow-2xl overflow-hidden border border-accent/10 rounded-sm journal-page-curl p-0",
        className,
      )}
    >
      {/* Paper Texture Overlay */}
      ...
      <div className="flex flex-col flex-1 min-w-0 relative z-20">
        ...
        <div className="px-5 pb-5 flex flex-col flex-1">
          <Link href={postUrl} className="block group/title mb-2">
