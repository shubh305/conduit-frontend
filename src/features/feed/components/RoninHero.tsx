...
export function RoninHero({ item, currentTenantSlug }: RoninHeroProps) {
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        {item.featuredImage ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-[#050505]">
            <span className="text-[#ff4655]/10 font-cinzel font-black text-6xl tracking-[0.3em] uppercase select-none">
              VANGUARD
            </span>
          </div>
        )}
