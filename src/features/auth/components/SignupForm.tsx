    ...
    <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-sm">
      <div className="space-y-2">
        ...
        <Input
          ...
          name="displayName"
          placeholder="NAME"
          className="bg-noir-bg border-noir-border focus:border-accent transition-colors text-foreground"
          required
        />
      </div>
      ...
      <Button
        type="submit"
        className="w-full bg-foreground text-noir-bg hover:bg-accent mt-6 font-bold"
        disabled={isLoading}
      >
