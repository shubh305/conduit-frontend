...
export function TechieMoreFromAuthor({
  ...
  return (
    <div className={cn("py-16 border-t border-white/5 bg-noir-bg", className)}>
      <div className="container mx-auto p-6 sm:p-12 lg:p-20 max-w-[1600px]">
              ...
              >
                ...
                <div className="relative aspect-[16/10] bg-noir-panel/30 overflow-hidden border-b border-white/5">
                  {post.featuredImage ? (
                    ...
                    <div className="flex items-center justify-center h-full text-accent/20 font-mono text-[10px] uppercase font-bold tracking-tighter">
                      DATA_MISSING
                    </div>
                  )}
