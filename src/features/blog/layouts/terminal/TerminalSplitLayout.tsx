 ...
 */
export function TerminalSplitLayout({ posts, tenantSlug }: LayoutProps) {
  return (
              ...
              <div key={post.id} className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[350px]">
                ...
                >
                  ...
                  <div className="mt-4 flex-1 flex flex-col justify-center">
                    ...
                    <h3 className={cn("text-xl md:text-2xl font-bold uppercase mb-4 leading-tight", TERMINAL_HOVER_TEXT)}>
                      {post.title}
                    </h3>
                    {post.excerpt && (
                  ...
                  <div className={cn("mt-auto pt-4 text-[10px] border-t border-accent/10 flex justify-between", TERMINAL_HOVER_TEXT_MUTED)}>
