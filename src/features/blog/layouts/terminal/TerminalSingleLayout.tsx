 ...
 */
export function TerminalSingleLayout({ posts, tenantSlug, currentTenantSlug }: LayoutProps) {
      ...
      <div className="border border-accent/30 bg-black flex-1 shadow-[0_0_15px_rgba(34,197,94,0.05)] relative overflow-hidden group mb-0">
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-12">
            ...
            {/* Read link */}
            <Link
              href={getPostUrl({ ...currentPost, postSlug: currentPost.slug, tenantSlug }, currentTenantSlug)}
          ...
          <div className="px-6 py-4 border-t border-accent/20 flex items-center justify-between mt-auto">
            ...
            <div className="text-[10px] text-foreground-muted">Press n/p to navigate • q to quit</div>
