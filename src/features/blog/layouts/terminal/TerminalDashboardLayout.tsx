 ...
 */
export function TerminalDashboardLayout({ posts, tenantSlug }: LayoutProps) {
  ...
  const getGridClasses = (index: number) => {
    switch (index) {
      case 0: return "md:col-span-1 md:row-span-2"; // Tall Left
      case 1: return "md:col-span-2 md:row-span-2"; // Big Hero Center
      case 2: return "md:col-span-1 md:row-span-1"; // Small Top Right
      case 3: return "md:col-span-1 md:row-span-2"; // Tall Right Sidebar
      case 4: return "md:col-span-2 md:row-span-1"; // Wide Bottom Left
      case 5: return "md:col-span-1 md:row-span-1"; // Small Bottom Middle
    ...
    <div className="w-full h-full flex flex-col font-mono">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    {/* Process header */}
                    <div className={cn("flex items-center justify-between text-[10px] mb-2 shrink-0", TERMINAL_HOVER_TEXT_ACCENT)}>
                      <span>PID:{metrics.pid}</span>
                      <span>CPU:{metrics.cpu}% MEM:{metrics.mem}%</span>
                    </div>
                    ...
                    {/* Footer */}
                    <div className={cn("mt-auto pt-2 text-[10px] border-t border-accent/10 truncate shrink-0", TERMINAL_HOVER_TEXT_ACCENT)}>
      ...
      <div className="border-x border-b border-accent/30 bg-accent/5 px-4 py-2 text-[10px] text-accent/60 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-accent">
          ...
          <span className="opacity-50">PAGE {currentPage + 1} OF {totalPages || 1}</span>
          <button 
